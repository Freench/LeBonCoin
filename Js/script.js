...
function genererCategorieSelelecteur(node, allCategories){
    ...
    selector.addEventListener("change", function(){
        document.getElementById('specificites-section').innerHTML = "";
        ajax('../Ajax/selectSpecificiteOfCategorie.php',  selector.options[selector.selectedIndex].value, genereFormSpecificite, document.getElementById('specificites-section') );
    })
}
